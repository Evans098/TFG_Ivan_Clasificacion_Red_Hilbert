...
# Cuantos paquetes se usan del dataset. una cantidad elevada mejora el sistema pero ojo con descompensar clases como Email
n_pcap = 80000
...
filename1 = 'F:/Estudiante/TFGF/IvanC/4_Database_procesada/Sesion/1_datos_sesion_CNN_1444px_5clases.pkl'
...
np.save('F:/Estudiante/TFGF/IvanC/1_Database_procesada/Datos_train_test/test_labels.npy',test_labels)
np.save('F:/Estudiante/TFGF/IvanC/1_Database_procesada/Datos_train_test/test_images.npy',test_images)
np.save('F:/Estudiante/TFGF/IvanC/1_Database_procesada/Datos_train_test/train_labels.npy',train_labels)
np.save('F:/Estudiante/TFGF/IvanC/1_Database_procesada/Datos_train_test/train_images.npy',train_images)
...
#%%
# Guardamos sesion
# filename2 = 'F:/Estudiante/TFGF/IvanC/2_Database_procesada/prueba(LSTM_desmodel).pkl'
#dill.dump_session(filename2)

#%%
# Guardamos la red, por si la utilizazmos despues

model.save('F:/Estudiante/TFGF/IvanC/1_Database_procesada/CNN_2D.h5')
# modelo = keras.models.load_model('F:/Estudiante/TFGF/IvanC/2_Database_procesada/CNN_2D.h5')
